...
The bbpe-core library is a streaming data processing engine designed to handle continuous data streams with SQL-defined transformations and aggregations. It provides real-time processing capabilities with performance optimizations through LLVM-based JIT compilation.
...
- `BBPE_HOME`: Base directory for configuration files (default: current directory)
